...
public class jcp_train
{
    ...
    private void processArguments(String[] args) throws JSONException {
  ...
  private void trainICC(double[] classes,
        ...
        if (_useMPC) {
            icc = new ConformalMultiProbabilisticClassifier(icc);
  ...
  private void trainTCC(String dataSetFileName)
        ...
        if (_useMPC) {
            tcc = new ConformalMultiProbabilisticClassifier(tcc);
